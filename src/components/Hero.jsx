...
function Hero() {
  return (
    <div
      className="hero flex flex-col md:flex-row-reverse pt-[3.5rem] 
    sm:pb-[2.5rem] sm:justify-center sm:items-center sm:pt-[1.5rem] 
    md:pt-[1.5rem] md:gap-6
   "
    >
      <div
        className=" imagen flex justify-center items-center md:flex-1 relative before:content-[''] 
      ...
      <div
        className="md:flex-1 pt-[3rem] m-4 
      sm:pt-[0.1rem]
